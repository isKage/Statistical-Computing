...
from utils import MultivariateNewtonOptimizer
...
def main():
    # initial optimizer
    multivariate_newton_optimizer = MultivariateNewtonOptimizer(
        f=log_likelihood,
        grad_f=log_likelihood_grad,
        hess_f=log_likelihood_hess,
        epsilon=1e-6,
        max_iter=50
    )

    # optimizer
    result = multivariate_newton_optimizer.optimize(x0=[0.1, 0.1])

    # summary
    multivariate_newton_optimizer.summary()
